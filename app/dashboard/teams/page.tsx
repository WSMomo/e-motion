...
export default function TeamsPage() {
  const teams = [
    { name: 'Engineering', count: 42, risk: 'Low', statusColor: 'bg-primary', chartColor: 'var(--theme-primary)', focus: '82%', overload: '34/100', history: mockTrendData(80, 5) },
  ...
  return (
    <div className="p-8 lg:p-12 max-w-7xl mx-auto flex flex-col gap-10">
      ...
      <header>
        <h1 className="font-manrope text-4xl lg:text-[2.75rem] font-light tracking-tight mb-2">Cohorts & Teams</h1>
